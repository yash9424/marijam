          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="#" className="block">
                <Image src="/app-store-badge.png" alt="Download on App Store" width={120} height={40} />
              </a>
              <a href="#" className="block">
                <Image src="/google-play-badge.png" alt="Get it on Google Play" width={120} height={40} />
              </a>
            </div>
          </div>
        </div>
